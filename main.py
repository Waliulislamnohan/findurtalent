...
load_dotenv()
MONGODB_URI = st.secrets["mongodb"]["MONGODB_URI"]  # Securely load your MongoDB URI from environment variables

MONGODB_DB = st.secrets["mongodb"]["MONGODB_DB"]
# Inject Custom CSS
css = """
<style>
/* Background Gradient */
...
db = client[MONGODB_DB]  # Ensure  is your actual database name
